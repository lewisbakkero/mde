...
A common critique of this high-speed world is that **A/B testing is traffic-bound.** If you have a finite number of users, you can only run so many tests before you run out of statistical power. [6](#ref-6) [7](#ref-7) [8](#ref-8)
